...
dag = DAG(
    'mysql_to_bigquery_etl',
    default_args=default_args,
    description='ETL DAG for MySQL to BigQuery data transfer',
...
# MySQL Connection and Data Extraction
def extract_data():
    try:
        ...
        query = "SELECT * FROM your_table WHERE date_trans >= DATE_SUB(CURDATE(), INTERVAL 30 DAY)"
